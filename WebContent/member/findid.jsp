...
<table class="table_w" border="1">
	<tr>
		...
		<td height="500px" valign="top" align="center">
			...
			<form action="findid_proc.jsp" method="post">
				<div class="ContentArea">
				<table width="60%">
					<tr>
						<td align="center" width="70%">
							<input type="text" name="name" class="log_input" placeholder="이름">
							<input type="text" name="phone" class="log_input" placeholder="핸드폰번호(-없이 입력)">
						</td>
						<td>
							<input type="submit" value="검색" class="loginBtn" onclick="return findid_chk()">
						</td>
					</tr>
					<tr>
						<td align="right">
